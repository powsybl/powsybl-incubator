...
import com.powsybl.cgmes.interpretation.model.interpreted.InterpretedBranch;
import com.powsybl.cgmes.interpretation.model.interpreted.InterpretedTransformer3;
import com.powsybl.cgmes.interpretation.model.interpreted.LineInterpretation;
import com.powsybl.cgmes.interpretation.model.interpreted.Transformer2Interpretation;
...
public class InterpretedComputedFlow {
    ...
    public static InterpretedComputedFlow forLine(CgmesLine line, String atNode, CgmesNode node1, CgmesNode node2,
        ...
        InterpretedBranch b = new LineInterpretation(line, node1, node2, config).interpret();
        f.equipmentModel = new DetectedEquipmentModel(b.detectedBranchModel());
    ...
    public static InterpretedComputedFlow forTransformer2(CgmesTransformer transformer, String atNode,
        ...
        InterpretedBranch b = new Transformer2Interpretation(transformer, config).interpret();
        f.equipmentModel = new DetectedEquipmentModel(b.detectedBranchModel());
