...
public class ProtobufImporter implements Importer {

    private static final Logger LOGGER = LoggerFactory.getLogger(ProtobufImporter.class);

    private static final String[] EXTENSIONS = {"piidm"};
    ...
    public String getComment() {
        return "IIDM protobuf v " + VERSION + " importer";
    }
    ...
    public Network importData(ReadOnlyDataSource dataSource, NetworkFactory networkFactory, Properties parameters) {
        ...
        try {
            ...
            network = IidmProtobuf.read(dataSource, networkFactory, options, ext);
            LOGGER.debug("PIIDM import done in {} ms", System.currentTimeMillis() - startTime);
        } catch (IOException e) {
