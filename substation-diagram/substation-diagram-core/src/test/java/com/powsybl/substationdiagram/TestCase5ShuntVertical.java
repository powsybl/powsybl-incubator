...
public class TestCase5ShuntVertical extends AbstractTestCase {
    ...
    public void test() throws IOException {
        ...
        assertEquals("SHUNT[FICT_vl_3, FICT_vl_laFictif, bs]", abstractCellShunt.getFullId());
        ...
        assertEquals(0, ((AbstractBusCell) abstractCellShunt).getPrimaryBlocksConnectedToBus().size());
